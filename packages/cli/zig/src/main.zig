...
fn dispatch(allocator: std.mem.Allocator, client: *control_plane_client.Client, argv: []const []const u8) !u8 {
...
fn sliceExecCommand(allocator: std.mem.Allocator, argv: []const []const u8) ![]const []const u8 {
