...
import type { BackupDestinationProvider, BackupDestinationResult, BackupTask, LocalBackupDestination } from "@platform/shared";

/**
 * Local filesystem backup destination provider.
 */
export class LocalBackupDestinationProvider implements BackupDestinationProvider {
    readonly id = "local";
