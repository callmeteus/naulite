...
import type { BackupDestinationProvider, BackupDestinationResult, BackupTask, NodeBackupDestination } from "@platform/shared";
 ...
 */
export class NodeBackupDestinationProvider implements BackupDestinationProvider {
    readonly id = "node";
